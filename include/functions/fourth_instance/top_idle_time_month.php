...
function top_idle_time_month()
{
	...
	$number = 1;
	$data ="[hr]";
	$question = "Select nickname, idle_month, online FROM user_stats ORDER BY idle_month DESC limit ".$config['function']['top_idle_time_month']['count'];
	$toptime = mysqli_query($connect, $question);	
				...
				$tsAdmin->channelEdit($config['function']['top_idle_time_month']['channel'], array(
